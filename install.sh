...
readonly REQUIRED_FILES=(
    ...
    # Core modülleri (3 dosya)
    "core/terminal-base.sh"
    "core/terminal-tools.sh"
    "core/terminal-config.sh"
    
    # Utils modülleri (3 dosya)
    "utils/helpers.sh"
    "utils/system.sh"
    "utils/config.sh"
    
    # Tema modülleri (7 dosya)
    "themes/dracula.sh"
    "themes/nord.sh"
    "themes/gruvbox.sh"
    "themes/tokyo-night.sh"
    "themes/catppuccin.sh"
    "themes/one-dark.sh"
    "themes/solarized.sh"
)
...
download_files() {
    ...
    mkdir -p core utils themes 2>/dev/null
    ...
    for file in "${REQUIRED_FILES[@]}"; do
        ...
        # Create directory if file is in a subfolder
